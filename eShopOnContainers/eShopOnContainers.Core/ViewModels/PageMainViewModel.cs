...
namespace eShopOnContainers.Core.ViewModels
{
    class PageMainViewModel : ViewModelBase
    {
        ...
        public List<string> FırsatÜrünleriCarousel = new List<string>();

        public List<string> SizinIcinSectiklerimizCarousel = new List<string>();

        public override async Task InitializeAsync(IDictionary<string, string> query)
        {
            FırsatÜrünleriCarousel = new List<string>()
            {
            ...
            SizinIcinSectiklerimizCarousel = new List<string>()
            {
            ...
            RaisePropertyChanged(() => FırsatÜrünleriCarousel);

            RaisePropertyChanged(() => SizinIcinSectiklerimizCarousel);
